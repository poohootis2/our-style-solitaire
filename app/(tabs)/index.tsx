...
const styles = StyleSheet.create({
  ...
  cartoonActionButton: { width: 76, height: 47, justifyContent: "center", alignItems: "center", borderRadius: 14, overflow: "visible", zIndex: 41, elevation: 0, borderWidth: 0, backgroundColor: "transparent", shadowOpacity: 0 },
