...
const styles = StyleSheet.create({
  ...
  monsterInfoBoss: { width: 80, flexGrow: 0, flexShrink: 0, flexBasis: 80 },
  monsterInfoPortrait: { width: 80, flexGrow: 0, flexShrink: 0, flexBasis: 80, flexDirection: "column", alignItems: "flex-end", alignSelf: "flex-end", position: "relative", zIndex: 10, elevation: 10 },
  ...
  monsterName: { width: 80, flexGrow: 0, flexShrink: 0, color: "#F3C969", fontSize: 12, lineHeight: 14, fontWeight: "900", letterSpacing: 0.5, textAlign: "right", zIndex: 11, elevation: 11 },
  monsterNameCentered: { width: 80, flexGrow: 0, flexShrink: 0, textAlign: "right" },
  ...
  monsterHp: { width: 80, color: "#BCEAE2", fontSize: 11, fontWeight: "800", marginTop: 2, textAlign: "right", alignSelf: "flex-end" },
